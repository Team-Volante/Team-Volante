    ...
    <>
        ...
        <div className="container">
          ...
          <div className="header-text">
            ...
            <div className="social-icon">
              <a href="https://www.linkedin.com/company/team-volante-official/about/">
                <i className="fa-brands fa-linkedin"></i>
              </a>
              {/* Replaced GitHub with WhatsApp group link per request */}
              <a href="https://chat.whatsapp.com/ECtg9BcHZBSI3E9tdcNqGu?mode=ems_copy_t" aria-label="WhatsApp group">
                <i className="fa-brands fa-whatsapp"></i>
              </a>
              <a href="https://youtube.com/@teamvolante2014?si=Fok2FhPoN7XDPo0k">
                <i className="fa-brands fa-youtube"></i>
              </a>
              <a href="https://www.instagram.com/team_volante/profilecard/?igsh=MTdyY2RrOWYxYng0Nw==">
      ...
      <div className="contact" id="contact" data-aos="fade-left">
        ...
        <div className="copyright">
          <p>
            Copyright © Harshendra. Made with Love &nbsp;&nbsp;
